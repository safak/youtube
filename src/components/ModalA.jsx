...
const ModalA = ({ closeModalA }) => {
  ...
  return (
    <Container>
      <ButtonClose onClick={() => closeModalA(false)}>X</ButtonClose>
      <Header>Invest in Loan "A"</Header>
      <Body>
        Available: ${loans[0].available}
      </Body>
      <Body>
        Annualised return: {loans[0].annualised_return}
      </Body>
      <Body>
        Term remaining: {loans[0].term_remaining}
      </Body>
      <Body>
        LTV: {loans[0].ltv}
      </Body>
