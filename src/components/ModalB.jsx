...
const ModalB = ({ closeModalB }) => {
  ...
  return (
    <Container>
      <ButtonClose onClick={() => closeModalB(false)}>X</ButtonClose>
      <Header>Invest in Loan "B"</Header>
      <Title></Title>
      <Body>
        Available: ${loans[2].available}
      </Body>
      <Body>
        Annualised return: {loans[2].annualised_return}
      </Body>
      <Body>
        Term remaining: {loans[2].term_remaining}
      </Body>
      <Body>
        LTV: {loans[2].ltv}
      </Body>
      ...
      <Input type="number" name="price" id="price" placeholder="Price..." ref={price}/>
        <Button  type="submit" value="Remove Money">INVEST B</Button>
      </Footer>
